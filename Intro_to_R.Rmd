...
- `update.packages()` function can be used to update installed packages
...
- The `str()` function displays the structure of an R object. It could shows, for example, a class of an object, number of observations (rows), number of variables (columns), names of variables, types of variables, and first few values
...
- The `head()` function returns the first part of an object (default - the six first observations/rows)
...
- [R is for archaeology](https://electricarchaeology.ca/2017/04/11/r-is-for-archaeology-a-report-on-the-2017-society-of-american-archaeology-meeting-by-b-marwick/)
